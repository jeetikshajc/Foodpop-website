...
<form method="post" id="searchrecipe" action="userhome.php">
<div class="jumbotron text-center">
  ...
  <div class="input-group">
      ...
      <div class="input-group-btn">
        <button type="submit" name="search1" form="searchrecipe" class="btn btn-danger">Search</button>
      </div>
    </div>
	<br>
	<div>
	<button type="button" onclick="window.location.href='userupload.php'" class="btn btn-danger" >Upload a Recipe</button>
	</div>
